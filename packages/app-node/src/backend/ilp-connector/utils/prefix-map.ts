 ...
 *   map.get("random")  // ⇒ null
 */
export default class PrefixMap<T> extends Map<string, T> {
   ...
   */
  protected readonly sortedKeys: string[] = []
   ...
   */
  *filterPrefixKeys(prefix: string): IterableIterator<string> {
   ...
   */
  *filterPrefix(prefix: string): IterableIterator<T> {
